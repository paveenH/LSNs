...
def main():
    ...
    positive_out = os.path.join(args.output_dir, f"positive_{args.size}_{args.pooling}.npy")
    negative_out = os.path.join(args.output_dir, f"negative_{args.size}_{args.pooling}.npy")
