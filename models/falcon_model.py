...
# -*- coding: utf-8 -*-
"""
Falcon model implementation for LSNs experiments.
"""
...
class FalconModel(BaseModel):
    ...
    def _load_model(self) -> None:
        ...
        logger.info(f"Loading Falcon model from {self.model_path}")
    ...
    def _get_model_info(self) -> None:
        ...
        logger.info(f"Falcon model info: {self.num_layers} layers, {self.hidden_size} hidden size")
