...
# -*- coding: utf-8 -*-
"""
Llama model implementation for LSNs experiments.
"""
...
class LlamaModel(BaseModel):
    ...
    def _get_model_info(self) -> None:
        ...
        logger.info(f"Llama model info: {self.num_layers} layers, {self.hidden_size} hidden size")
