...
# -*- coding: utf-8 -*-
"""
Mistral model implementation for LSNs experiments.
"""
...
class MistralModel(BaseModel):
    ...
    def _get_model_info(self) -> None:
        ...
        logger.info(f"Mistral model info: {self.num_layers} layers, {self.hidden_size} hidden size")
