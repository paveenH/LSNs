...
# -*- coding: utf-8 -*-
"""
Phi3 model implementation for LSNs experiments.
"""
...
class Phi3Model(BaseModel):
    ...
    def _load_model(self) -> None:
        ...
        logger.info(f"Loading Phi3 model from {self.model_path}")
    ...
    def _get_model_info(self) -> None:
        ...
        logger.info(f"Phi3 model info: {self.num_layers} layers, {self.hidden_size} hidden size")
